...
class Var(object):
    ...
    if HAS_SSL:
        URL = "https://{https://newdm-7195089bab8c.herokuapp.com}/".format(FQDN)
    else:
        URL = "http://{https://newdm-7195089bab8c.herokuapp.com}/".format(FQDN)
    DATABASE_URL = str(getenv('DATABASE_URL', ''))
    UPDATES_CHANNEL = str(getenv('UPDATES_CHANNEL', 'updatechnl')) 
